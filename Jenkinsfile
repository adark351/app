pipeline {
    ...
    environment {
        ...
        APP_NAME = 'my-flask-app'   // Name of your Docker image
        ...
        GIT_REPO = 'https://github.com/adark351/app.git' // Your GitHub repository
    }
    ...
    stages {
        ...
        stage('Build Docker Image') {
            steps {
                script {
                     sh "sudo docker build -t ${DOCKER_REGISTRY}/${APP_NAME}:${IMAGE_TAG} ."
                }
            }
        }
